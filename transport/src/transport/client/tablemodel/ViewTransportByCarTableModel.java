...
public class ViewTransportByCarTableModel extends GenericTableModel {

  private TransportFactory tf;
  private Transport[] rowData;

  public ViewTransportByCarTableModel(int id) {
    tf = new TransportFactory();
    rowData = tf.getAllTransportsByCarID(id);
  }
  public ViewTransportByCarTableModel() {
      tf = new TransportFactory();
  }

  public void setRowDataCurrent(int id){
    rowData= tf.getAllCurrentTransportsByCarID(id);

  }
  public void setRowDataFuture(int id){
    rowData= tf.getAllFutureTransportsByCarID(id);

  }
  public void setRowDataFinished(int id){
    rowData= tf.getAllFinishedTransportsByCarID(id);
