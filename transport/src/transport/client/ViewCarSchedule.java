...
public class ViewCarSchedule extends javax.swing.JInternalFrame {
	...
	private void jbInit() { //GEN-BEGIN:jbInit
		...
		buttonClose.addActionListener(new
									  ViewCarSchedule_buttonClose_actionAdapter(this));
		jPanel1.setLayout(gridLayout1);
		comboSelectCar.addActionListener(new
			ViewCarSchedule_comboSelectCar_actionAdapter(this));
	...
	private void initTableFinished() {
		...
		objectTableFinished.setSelectionMode(ListSelectionModel.
											 SINGLE_SELECTION);
		objectTableFinished.setCellSelectionEnabled(false);
		setClosable(true);
		this.setMaximizable(true);
...
class ViewCarSchedule_buttonClose_actionAdapter implements java.awt.event.
	ActionListener {
...
class ViewCarSchedule_comboSelectCar_actionAdapter implements java.awt.event.
	ActionListener {
	ViewCarSchedule adaptee;
